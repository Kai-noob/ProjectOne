...
import 'package:flutterproject/screens/userdetials/userprofilefill.dart';

import 'signIn/components/customcontainer.dart';

	
	class SignUpPage extends StatefulWidget {
	SignUpPage({ key, required this.title}) : super(key: key);
	...
	return InkWell(
    onTap: (){
      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>UserProfileFill()));
    },
      child: Container(
